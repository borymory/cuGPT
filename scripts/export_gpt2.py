...
def export_gpt2_weights_tensor_grouped(filepath="gpt2_124m.bin"):
    ...
    with open(filepath, "wb") as f:
        ...
        # Layer 0 W_Q, Layer 1 W_Q, ... Layer 11 W_Q
        for i in range(config["layers"]):
...
if __name__ == "__main__":
    export_gpt2_weights_tensor_grouped("checkpoints/gpt2_124m.bin")