...
The following up task is setting up FlashAttn for the suitable tensor sizes, Q,K,V tensor preparation and causal mask application. Backward kernels are right now out of scope for complexity and accessibility reasons.